...
#define STRING_CONFIG_H_AUTHOR "Alex, 1/8/19" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "HEWWO? MISTER OBAMA???"         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "Spooder th Extruder"
...
#define DELTA
  ...
  // Delta calibration menu, uncomment to add three points calibration menu option.
